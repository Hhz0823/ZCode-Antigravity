...
a persistent Windows taskbar/macOS menu-bar quota widget, Grok billing, Agent connector cards,
a no-console graphical control center, and a SHA-256 verified single-BAT Windows installer.
...
.\packaging\windows\Build-Single-Bat.ps1 `
  ...
  -OutputFile C:\path\to\ZCode-Antigravity-OneClick-v0.3.0-test.bat
```
...
.\packaging\windows\Build-Exe-Installer.ps1 `
  -PackageDir C:\path\to\expanded-package `
  -OutputFile C:\path\to\ZCode-Antigravity-Setup-v0.3.0-test.exe
```

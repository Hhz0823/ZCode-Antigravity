...
ZCode-Antigravity-Setup-v0.4.3-test.exe. This is a native Windows GUI installer: it shows no
...
ZCode-Antigravity-OneClick-v0.4.3-test.bat. It verifies and extracts its embedded package,
...
Installer formats
-----------------
- ZCode-Antigravity-Setup-v0.4.3-test.exe: recommended no-terminal current-user installer.
- ZCode-Antigravity-OneClick-v0.4.3-test.bat: fallback single-file installer.
- ZCode-Antigravity-Windows-x64-0.4.3-test.zip: manually verifiable expanded package.
...
Build versions
--------------
- ZCode Antigravity Bridge: 0.4.3-test

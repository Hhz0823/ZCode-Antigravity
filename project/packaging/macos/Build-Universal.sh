...
release_version=${VERSION:-1.0.3-test}
short_version=${SHORT_VERSION:-1.0.3}
bundle_version=${BUNDLE_VERSION:-1003}
...
for target_arch in arm64 amd64; do
  ...
  backend_ldflags="-s -w -X main.Version=7.2.132-zcode.14 -X main.Commit=$commit -X main.BuildDate=$build_date"

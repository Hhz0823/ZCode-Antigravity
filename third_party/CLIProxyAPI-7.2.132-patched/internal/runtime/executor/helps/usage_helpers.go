...
func (r *UsageReporter) setTTFT(ttft time.Duration) {
	...
	if ttft <= 0 {
		// Extremely fast in-process responses can fall within one Windows clock
		// tick. Preserve the semantic distinction between "measured immediately"
		// and "TTFT was never observed".

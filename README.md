...
- `gemini-3.8-flash`：最新主力对话、编程与多模态理解模型（上游路由至 `gemini-3.8-flash-high`）。
- `gemini-3.7-flash`：通用对话、编程与多模态理解（上游路由至 `gemini-3.7-flash-high`）。
- `gemini-3.6-flash`：兼容模型（上游路由至 `gemini-3.6-flash-high`）。
